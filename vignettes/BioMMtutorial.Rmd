...
```
Note that, two different parallel computing approaches are implemented: the parallel package is used in Github version (Only for linux and MAC OS) and the BiocParallel is for Bioconductor.
...
param1 <- MulticoreParam(workers = 1, progressbar=TRUE)
param2 <- MulticoreParam(workers = 10, progressbar=TRUE)
