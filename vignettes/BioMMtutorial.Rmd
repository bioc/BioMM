...
```
Note that, two different parallel computing strategies are implemented: For BioMM package installed from the Github, the parallel R package is implemented. The BiocParallel R package is employed in Bioconductor BioMM package which allows the use of parallel computation across possible systems.
