...
date: "Modified: 10 July 2019. Compiled: `r format(Sys.Date(), '%d %b %Y')`"
output: 
...
## Map to pathways (only 100 pathways in order to reduce runtime)
...
studyDataSub <- studyData[,1:2000] ## reduce runtime
