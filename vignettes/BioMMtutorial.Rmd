...
```
Note that, two different parallel computing approaches are implemented: the parallel package is implemented in Github version (Only for linux and MAC OS) and the BiocParallel is for Bioconductor.
